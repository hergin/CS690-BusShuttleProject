...
public class DataManager {
    ...
    public DataManager() {
        ...
        Loops[1].Stops.Add(Stops[0]);
        Loops[1].Stops.Add(Stops[1]);
        Loops[1].Stops.Add(Stops[2]);

        Loops[2].Stops.Add(Stops[2]);
        Loops[2].Stops.Add(Stops[3]);
        Loops[2].Stops.Add(Stops[4]);
